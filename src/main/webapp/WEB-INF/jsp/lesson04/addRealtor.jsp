	...
	<div class="container">
		...
		<form method="post" action="/lesson04/ex02/add_student">
			...
			<div class="form-group">
				...
				<input type="text" name="address" id="address" class="form-control col-3" placeholder="이메일을 입력하세요">
			</div>
			<div class="form-group">
				<label for="grade">등급</label>
				<input type="text" name="grade" id="grade" class="form-control col-3" placeholder="장래희망을 입력하세요"></input>
			</div>
